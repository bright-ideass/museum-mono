...
export class MainLayoutComponent extends UnsubscribeOnDestroyAdapter implements AfterViewInit {
  ...
  ngAfterViewInit(): void {
    ...
    if (localStorage.getItem('choose_skin')) {
      ...
      if (localStorage.getItem('choose_skin') === 'theme-white') {
        this.renderer.addClass(this.document.body, 'theme-white');
        localStorage.setItem('choose_skin', 'theme-white');
        localStorage.setItem('choose_skin_active', 'white');

      }
      if (localStorage.getItem('choose_skin') === 'theme-black') {
    ...
    if (localStorage.getItem('menuOption')) {
      ...
      if (localStorage.getItem('theme') === 'menu_light') {
        this.renderer.addClass(this.document.body, 'menu_light')
      }
      if (localStorage.getItem('theme') === 'menu_dark') {
  ...
  sanitizeStoredValue(value: string): string {
